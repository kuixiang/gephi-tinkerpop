...
import org.gephi.tinkerpopfilters.api.PropertyExecutor.Callback;
...
public class FilterThread extends Thread {
    ...
    ProgressTicketProvider progressTicketProvider = null;
    ...
    public void run() {
        if (running) {
            ...
            //Progress
            progressTicketProvider = Lookup.getDefault().lookup(ProgressTicketProvider.class);
...
//        System.out.println("#Edges: " + result.getEdgeCount());
    ...
    public boolean cancel() {
        this.running = false;
        ProgressTicketProvider progressTicketProvider = Lookup.getDefault()
