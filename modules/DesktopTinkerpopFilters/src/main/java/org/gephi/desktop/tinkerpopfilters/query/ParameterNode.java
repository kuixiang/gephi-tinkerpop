...
public class ParameterNode extends AbstractNode {
    ...
    public ParameterNode(String key, Object value) {
        ...
        setName(key + ": " + valStr);
        setIconBaseWithExtension("org/gephi/desktop/tinkerpopfilters/query/resources/parameter.png");
    }
    ...
    public ParameterNode(Query function) {
        ...
        setIconBaseWithExtension("org/gephi/desktop/tinkerpopfilters/query/resources/parameters.png");
    }
