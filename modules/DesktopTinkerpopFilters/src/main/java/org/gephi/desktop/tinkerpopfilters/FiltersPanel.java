 ...
 */
package org.gephi.desktop.tinkerpopfilters;
...
import org.gephi.desktop.tinkerpopfilters.library.FiltersExplorer;
import org.gephi.desktop.tinkerpopfilters.query.QueryExplorer;
import org.gephi.tinkerpopfilters.api.FilterController;
import org.gephi.tinkerpopfilters.api.FilterModel;
...
//                uiModel.setSelectedQuery(null);
        ...
        stopButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                if (uiModel.getSelectedQuery() != null ) {
                    FilterController controller = Lookup.getDefault()
                        .lookup(FilterController.class);
                    //stop filter builder and filter execution
                    if (filterModel != null) {
                        filterModel.setFiltering(false);
                        filterModel.stop();
                    }
                    //stop filter thread
    ...
    private void initComponents() {
        ...
        exportColumnButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/org/gephi/desktop/tinkerpopfilters/resources/table_export.png"))); // NOI18N
        ...
        exportWorkspaceButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/org/gephi/desktop/tinkerpopfilters/resources/workspace_export.png"))); // NOI18N
        ...
        exportLabelVisible.setIcon(new javax.swing.ImageIcon(getClass().getResource("/org/gephi/desktop/tinkerpopfilters/resources/labelvisible_export.png"))); // NOI18N
        ...
        */
        ...
        stopButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/org/gephi/desktop/tinkerpopfilters/resources/stop.png"))); // NOI18N
        ...
        filterButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/org/gephi/desktop/tinkerpopfilters/resources/filter.png"))); // NOI18N
