...
import org.gephi.desktop.tinkerpopfilters.query.QueryNode;
...
public class CategoryNode extends AbstractNode {
    ...
    public Image getIcon(int type) {
        ...
        if (category == null) {
            return ImageUtilities.loadImage("org/gephi/desktop/tinkerpopfilters/library/resources/library.png");
        } else {
            return ImageUtilities.loadImage("org/gephi/desktop/tinkerpopfilters/library/resources/folder.png");
        }
    }
