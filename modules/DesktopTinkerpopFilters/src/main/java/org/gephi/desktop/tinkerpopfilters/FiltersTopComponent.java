...
@ConvertAsProperties(dtd = "-//org.gephi.desktop.tinkerpopfilters//Filters//EN",
autostore = false)
@TopComponent.Description(preferredID = "TinkerpopFiltersTopComponent",
iconBase = "org/gephi/desktop/tinkerpopfilters/resources/small.png",
persistenceType = TopComponent.PERSISTENCE_ALWAYS)
@TopComponent.Registration(mode = "filtersmode", openAtStartup = true, roles = {"overview"})
@ActionID(category = "Window", id = "org.gephi.desktop.tinkerpopfilters.FiltersTopComponent")
@ActionReference(path = "Menu/Window", position = 1500)
@TopComponent.OpenActionRegistration(displayName = "#CTL_TinkerpopFiltersTopComponent",
preferredID = "TinkerpopFiltersTopComponent")
public final class FiltersTopComponent extends TopComponent {

    private static FiltersTopComponent instance;
    static final String ICON_PATH = "org/gephi/desktop/tinkerpopfilters/resources/small.png";
    private static final String PREFERRED_ID = "TinkerpopFiltersTopComponent";
    //Panel
    ...
    public FiltersTopComponent() {
        initComponents();
        setName(NbBundle.getMessage(FiltersTopComponent.class, "CTL_TinkerpopFiltersTopComponent"));
